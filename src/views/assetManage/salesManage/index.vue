<template>
  <div class="app-container">
    ...
    <SalesDialog ref="salesDialogRef" />
  </div>
</template>
...
export default {
  ...
  components: {
    ...
    SalesDialog: () => import("../components/SalesDialog")
  },
  data() {
    return {
      searchText: "",
        ...
        httpRequest: () => {
          return Promise.resolve({
            rows: [{
              ...
              table_xx_7: "130",
              table_xx_8: "123",
              table_xx_9: "2021-汽车后视镜（马自达）超过文字111",
            }, {
              id: 2,
              table_xx_1: "09872",
      ...
      operationList: [
        ...
        },
        {
          text: "删除",
          handleClick: () => {
            msgTipBox(this, {msg: "是否确认要删除此销售单"},() => {})
          },
        },
      ],
    };
  ...
  methods: {
    ...
    handleAddEdit(row) {
      this.$refs.salesDialogRef.show(row)
    },
  },
};
</script>
